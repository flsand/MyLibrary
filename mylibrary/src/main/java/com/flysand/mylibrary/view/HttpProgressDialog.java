package com.flysand.mylibrary.view;
...
public class HttpProgressDialog extends Dialog {
    ...
    synchronized public void dismissWithSuccess(String message, int... time) {
        showSuccessImage();
        if (message != null) {
            tvMessage.setText(message);
        } else {
    ...
    synchronized public void dismissWithFailure(String message, int... time) {
        showFailureImage();
        if (message != null) {
            tvMessage.setText(message);
        } else {
    ...
    synchronized protected void showSuccessImage() {
        ivProgressSpinner.setVisibility(View.GONE);
        ivSuccess.setVisibility(View.VISIBLE);
    }

    synchronized protected void showFailureImage() {
        ivProgressSpinner.setVisibility(View.GONE);
